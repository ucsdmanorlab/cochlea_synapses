...
def train_until(max_iteration, reject_on=True):
...
if __name__ == '__main__':
    ...
    reject_iterations = 10000
    max_iterations = 100000
    train_until(reject_iterations, reject_on=True)
    train_until(max_iterations-reject_iterations, reject_on=False)
