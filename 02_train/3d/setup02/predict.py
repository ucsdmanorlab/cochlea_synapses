...
def predict(
    ...
    input_size = gp.Coordinate((52,)*3) * voxel_size
    output_size = gp.Coordinate((12,)*3) * voxel_size
...
#    raw_file = '../../../01_data/zarrs/sample_0.zarr'
    raw_files = glob.glob('../../../01_data/zarrs/glu/8-bit/validation/*.zarr')
    ...
    for raw_file in raw_files:
        ...
        out_file['pred_mask'].attrs['offset'] = [0,]*3
        out_file['pred_mask'].attrs['resolution'] = [1,]*3

        out_file['labeled'] = labeled
        out_file['labeled'].attrs['offset'] = [0,]*3
