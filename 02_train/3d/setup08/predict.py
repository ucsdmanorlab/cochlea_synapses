...
if __name__ == '__main__':
    ...
    for raw_file in raw_files:
        ...
        save_out(out_file, np.asarray(zarr.open(raw_file+'/raw')), 'raw')
        save_out(out_file, np.asarray(pred_affs), 'pred_affs_noaug')
        save_out(out_file, np.asarray(pred_lsds), 'pred_lsds_noaug')
