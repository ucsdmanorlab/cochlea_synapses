...
raw_files = sorted(glob.glob('../../../01_data/zarrs/sampled_out/medium/A5_Base*.zarr'))
...
for raw_file in raw_files:
    ...
    #min_affs = np.amin(pred, axis=0)
    mean_affs = np.mean(pred, axis=0)
    ...
    out_file['mean_test'].attrs['offset'] = out_file['pred_affs_100'].attrs['offset']
    out_file['mean_test'].attrs['resolution'] = out_file['pred_affs_100'].attrs['resolution']
    
    out_file['max_test'] = max_affs #labeled.astype(np.uint64)
    out_file['max_test'].attrs['offset'] = out_file['pred_affs_100'].attrs['offset']
    out_file['max_test'].attrs['resolution'] = out_file['pred_affs_100'].attrs['resolution']

    #out_file['min_test'] = min_affs #labeled.astype(np.uint64)
    #out_file['min_test'].attrs['offset'] = out_file['pred_affs_100'].attrs['offset']
    #out_file['min_test'].attrs['resolution'] = out_file['pred_affs_100'].attrs['resolution']
