...
def train_until(max_iteration):
    ...
    #synapse_mask = ArrayKey('SYNAPSE_MASK')
    #unlabelled_mask = ArrayKey('UNLABELLED_MASK')
    ...
    #request.add(synapse_mask, output_size)
    ...
    train_pipeline += IntensityAugment(raw, 0.6, 1.1, -0.2, 0.2, z_section_wise=True)
