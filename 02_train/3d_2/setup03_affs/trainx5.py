...
dt = dt[0:dt.rfind('.')]
run_base_name = dt+'_3d_affs_rej0p005_ramp_noclip_dil1' #"2022-11-21_16-37-373d_affs" #dt+'3d_affs'
...
def train(iterations):
    ...
    sources = tuple(
            gp.ZarrSource(
                ...
                gp.RandomLocation()  +
                gp.Reject_CMM(mask=labels_mask, min_masked=0.005, min_min_masked=0.001) #reject_probability=0.95) 
...
if __name__ == "__main__":
    ...
    for i in range(5):
        run_name = run_base_name+'_'+str(i)
        train(1001)
