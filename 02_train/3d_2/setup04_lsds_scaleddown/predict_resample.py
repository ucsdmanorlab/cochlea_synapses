...
def predict(
    ...
    source = gp.ZarrSource(
        raw_file,
            {
                raw_orig: raw_dataset
            },
            {
                raw_orig: gp.ArraySpec(
                    interpolatable=True,
                    voxel_size=vox)
            })
...
if __name__ == '__main__':
    ...
    checkpoint = 'model_2023-03-23_15-47-26_3d_scaled_mid_r0p9_checkpoint_10000'
    ...
    for raw_file in raw_files:
        ...
        save_out(out_file, pred_reshape, 'pred_resample')
