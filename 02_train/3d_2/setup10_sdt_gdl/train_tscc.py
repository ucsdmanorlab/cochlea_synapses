...
from utils import Reject_CMM, calc_max_padding, ComputeDT, BalanceLabelsWithIntensity, CheckPred #CheckSnaps #check_snaps
...
def train(
    ...
    pipeline += gp.Squeeze([raw, gt, pred, mask_weights])
