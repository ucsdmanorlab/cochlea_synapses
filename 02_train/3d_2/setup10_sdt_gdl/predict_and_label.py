...
if __name__ == '__main__':
    ...
    raw_files = glob.glob('../../../01_data/tifs/zarrs/*.zarr')#train/spinning*.zarr')#validate/*.zarr') 
    ...
    for raw_file in raw_files:
        ...
        if save_labels:
            print("Labeling ...")
            segmentation = segmentation = sdt_to_labels(
                    pred, 
                    peak_thresh=0.2,
                    mask_thresh=0.0)
            save_out(out_file, segmentation, 'pred_labels', save2d=False, res=raw_res)
