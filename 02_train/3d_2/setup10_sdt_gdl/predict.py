...
if __name__ == '__main__':
    ...
    model = 'model_2025-02-21_10-32-24_MSE0GDL1' #model_2024-11-19_11-35-27_3d_sdt_IntWgt_b1_libcil' #'model_2024-04-15_12-39-03_3d_sdt_IntWgt_b1_dil1'
    checkpoint = model+'_checkpoint_2000'
    raw_files = glob.glob('../../../01_data/zarrs/wpz*.zarr')#validate/*.zarr') 
    #validate/spinning*.zarr') #validate/*.zarr')
    
    for raw_file in raw_files:
        print(raw_file)
        out_file = zarr.open(raw_file.replace('01_data/zarrs',#/validate', 
            '03_predict/3d/'+checkpoint))
